class ContactUs_Page {
	...
	setFirstName(firstName) { return this.firstName.setValue(firstName);}
	setLastName(lastName) {	return this.lastName.setValue(lastName);}
	setEmailAddress(emailAddress) { return this.emailAddress.setValue(emailAddress);}
	setComments(comments) {	return this.comments.setValue(comments);}
	clickSubmitButton() { return this.submitButton.click();}
	...
	submitAllInformationViaContactUsForm(firstName, lastName, emailAddress, comments) {
		...
		if(emailAddress) { this.emailAddress.setValue(emailAddress);}
